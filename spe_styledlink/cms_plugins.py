...
class StyledLinkPlugin(CMSPluginBase):
    ...
    form = StyledLinkForm
    name = _("Styled Link")
    render_template = "spe_styledlink/styled_link.html"
    text_enabled = True
    allow_children = True
    ...
    def icon_src(self, instance):
        if instance.link == '':
            return settings.STATIC_URL + u'spe_styledlink/images/link-error.png'
        else:
            return settings.STATIC_URL + u'spe_styledlink/images/link.png'
