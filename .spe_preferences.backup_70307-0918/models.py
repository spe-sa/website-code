...
class ContactPreference(models.Model):
    ...
    promo_contact_via_pmail = models.NullBooleanField(verbose_name="Send Promotional Info via Postal Mail?", choices=BOOLEAN_CHOICES, default=None)
    promo_contact_via_email = models.NullBooleanField(verbose_name="Send Promotional Info via Email?", choices=BOOLEAN_CHOICES, default=None)
    # email_subscription_choices = models.CharField(max_length=180, verbose_name="Email Subscription Choices", blank=True)
    email_subscription_jpt = models.NullBooleanField(verbose_name="Subscribe to JPT via email?", choices=BOOLEAN_CHOICES, default=None)
    email_subscription_ogf = models.NullBooleanField(verbose_name="Subscribe to OGF via email?", choices=BOOLEAN_CHOICES, default=None)
    email_subscription_hse = models.NullBooleanField(verbose_name="Subscribe to HSE Now via email?", choices=BOOLEAN_CHOICES, default=None)
    email_subscription_twa = models.NullBooleanField(verbose_name="Subscribe to TWA via email?", choices=BOOLEAN_CHOICES, default=None)
    email_subscription_rdn = models.NullBooleanField(verbose_name="Subscribe to Region/Discipline eNewsletter via email?", choices=BOOLEAN_CHOICES, default=None)
    when_submitted = models.DateTimeField(default=timezone.now, blank=True)
    user_name1_cookie = models.CharField(max_length=36, verbose_name="First Name or Given Name (cookie)", blank=True)
    user_name1_given = models.CharField(max_length=36, verbose_name="First Name or Given Name (override)", blank=True)
    user_name2_cookie = models.CharField(max_length=36, verbose_name="Last Name or Family Name (cookie)", blank=True)
    user_name2_given = models.CharField(max_length=36, verbose_name="Last Name or Family Name (override)", blank=True)
    ...
    user_email_given = models.CharField(max_length=90, verbose_name="User Email Address (override)", blank=True)
    user_cid_cookie = models.CharField(max_length=12, verbose_name="User Constituent ID# (cookie)", blank=True)
    user_cid_given = models.CharField(max_length=12, verbose_name="User Constituent ID# (override)", blank=True)
    ...
    user_loc_given = models.CharField(max_length=90, verbose_name="User Location/Country (override)", blank=True)
    user_mid_given = models.CharField(max_length=18, verbose_name="Marketo ID# (given)", blank=True)
    ...
    user_viewport_x = models.IntegerField(verbose_name="Viewport Width", blank=True, default=None)  # CharField(max_length=40, verbose_name="User Agent (full)", blank=True)
    user_viewport_y = models.IntegerField(verbose_name="Viewport Height", blank=True, default=None)
    submitted_via = models.URLField(max_length=180, verbose_name="Submission Referral URL", blank=True)

    def __str__(self):
        return "[uvi=" + self.user_vid + " uea=" + self.user_email + " ulc=" + self.user_loc + " uci=" + self.user_cid + "] cvp=" + str(self.promo_contact_via_pmail) + " cve=" + str(self.promo_contact_via_email) + " esubs=" + str(self.email_subscription_choices) + " ts=" + str(self.when_submitted)
