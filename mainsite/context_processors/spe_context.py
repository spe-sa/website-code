from mainsite.common import get_visitor, get_context_variable, get_context_variables, sanitize, is_private_ip
import logging
import json
...
def set_default_values(request):
    ...
    #     # removing as this was temporary until I got cip working
