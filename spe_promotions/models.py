...
class SimpleEventNonMemberPromotion(models.Model):
    ...
    start = models.DateField(verbose_name='Display Start Date', editable=False, blank=True, null=True)
    end = models.DateField(verbose_name='Display End Date', editable=False, blank=True, null=True)
